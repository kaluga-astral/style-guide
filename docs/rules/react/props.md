...
Соответствует [единому правилу нейминга Boolean свойства и параметры](../naming/props#boolean-свойства-и-параметры-должны-иметь-префикс-указывающий-на-принадлежность-к-boolean).
